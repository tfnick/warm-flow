...
public class FlowTaskDaoImpl extends WarmDaoImpl<FlowTask> implements FlowTaskDao<FlowTask> {
    ...
    @Override
    public Page<FlowTask> selectPage(FlowTask entity, Page<FlowTask> page) {
        return null;
    }
    ...
    public List<FlowTask> getByInsIdAndNodeCodes(Long instanceId, List<String> nodeCodes) {
        ...
        sql.append(" where instance_id = ? and node_code in (");
        sql.append(buildInPlaceholders(nodeCodes.size())).append(")");
