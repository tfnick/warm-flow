...
public class FlowAutoSqltoyConfig extends BeanConfig {
    ...
    public void after(WarmFlow flowConfig) {
        DataSource dataSource = sqlToyContext.getDefaultDataSource();
        CommonUtil.setDataSourceType(flowConfig, dataSource);
    }
